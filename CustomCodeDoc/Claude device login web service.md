...
A company admin cannot run the Claude/Codex logins today —
`assertCanManageVaults` ([`routes/claude-vaults.ts:32`](server/src/routes/claude-vaults.ts#L32))
...
choice — `/sysops/llm/claude/ACME/alice` — is wrong and quietly so.
